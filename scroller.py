...
# Grab the message and delay from the command line
message = sys.argv[1]
if len(sys.argv) > 1:
...
# Scroll the ip address of the host
#show_ip_address(tm)
roll()

# Convert message to hex and scroll
scroller(tm,convert_to_hex(str(message)),delay)
